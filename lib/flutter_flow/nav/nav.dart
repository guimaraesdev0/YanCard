...
class AppStateNotifier extends ChangeNotifier {
  ...
  YanCardAuthUser? initialUser;
  YanCardAuthUser? user;
  ...
  void update(YanCardAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Solicitar_Saque',
          path: '/Solicitar_saque',
        ...
        FFRoute(
          name: 'Minhas_contas',
          path: '/Minhas_contas',
          builder: (context, params) => MinhasContasWidget(),
        ),
        FFRoute(
          name: 'Nova_conta',
          path: '/Nova_conta',
          builder: (context, params) => NovaContaWidget(),
        ),
        FFRoute(
          name: 'Detalhes_cartao',
          path: '/Detalhes_cartao',
          builder: (context, params) => DetalhesCartaoWidget(),
        ),
        FFRoute(
