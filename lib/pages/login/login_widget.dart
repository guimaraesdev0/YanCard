                                ...
                                onPressed: () async {
                                  ...
                                  if ((_model.apiResultj0r?.succeeded ??
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Erro ao fazer login: ${getJsonField(
                                            (_model.apiResultj0r?.jsonBody ??
                                                ''),
                                            r'''$.error''',
                                          ).toString()}',
