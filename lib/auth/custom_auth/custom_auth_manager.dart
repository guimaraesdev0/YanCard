...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    yanCardAuthUserSubject.add(
      YanCardAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<YanCardAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  YanCardAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = YanCardAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    yanCardAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
