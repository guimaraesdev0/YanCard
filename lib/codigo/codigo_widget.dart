                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                _model.apiResult3xi =
                                    await VerifyRecoveryCodeCall.call(
                                  code: _model.novaSenhaTextController.text,
                                );

                                if ((_model.apiResult3xi?.succeeded ?? true)) {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Código de recuperação inválido, verifique novamente,',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryText,
                                        ),
